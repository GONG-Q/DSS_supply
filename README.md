...
├── p4d_vango_prompt.txt
│   └── P4D optimized adversarial prompts for different target concepts.
│
...
│   └── DSS-aware adaptive adversarial prompts optimized against the DSS
│       pipeline for different concepts.
│
├── nudity_optimized_adversarial_prompts_report.txt
...
These materials correspond to the additional security evaluations introduced
in the minor revision:
...
The provided prompt files contain the adversarial inputs used in the revised
evaluation. The corresponding report files record optimization information and
attack-related statistics. The visualization directory provides generated
examples for qualitative inspection.

These materials are released to facilitate verification of the additional
robustness experiments introduced during the minor revision. 
